...
register_help(_S, "= / s", "Fill / sort selection", order=21)
...
register_help(_S, ":sort <col> asc|desc", "Sort rows by column", order=40)
...
register_help(_S, ":replace <old> <new>", "Find and replace", order=51)
...
register_help(_S, ":load theme <name>", "Change theme  (dracula/light/gruvbox/nord)", order=120)
