"""JSON I/O for PySheet.

.pysheet  — lossless native format (formulas, formatting, multi-sheet)
...
class JSONAdapter(FormatAdapter):
    ...
    .pysheet  →  lossless native (formulas, formatting, multi-sheet)
    ...
    # ------------------------------------------------------------------ #
    # Native format  (.pysheet / .json with "sheets" key)                  #
    # ------------------------------------------------------------------ #
